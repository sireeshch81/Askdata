...
class MLMongoDBLoader:
    ...
    def __init__(self,
        ...
        # MongoDB connection parameters - Read from environment variables if not provided
        self.mongo_host = mongo_host or os.environ.get("MONGO_HOST", "localhost")
        self.mongo_port = mongo_port or int(os.environ.get("MONGO_PORT", 27017))
        self.mongo_database = mongo_database or os.environ.get("MONGO_DATABASE", "askdata_mongo")
        self.mongo_username = mongo_username or os.environ.get("MONGO_INITDB_ROOT_USERNAME")
        self.mongo_password = mongo_password or os.environ.get("MONGO_INITDB_ROOT_PASSWORD")
